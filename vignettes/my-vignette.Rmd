...
For VARX models irf_VAR_CB function can be used to generate response functions to exogenous shocks. In the following example there are two exogenous variables. Using the option irf="irfX" we obtain impulse response functions to exogenous shocks.
...
MIxCIVARData function is used to generate CIVAR data with mixed I(1) and I(0) variables. It is also used to estimate the mixed CIVAR models. The following exampel generated a set of data from a mixed CIVAR process.  
...
plot(ts(RR$Y))
```
The graph indicates that among the 9 variables there two I(0) variables and 7 I(1) variables. 
